...
STATES_DICT = {
    ...
    "StateEnergyValue":
        "MolecularStateCharacterisation.StateEnergy.Value",
    "StateEnergyUnit":
        "MolecularStateCharacterisation.StateEnergy.Value.@units",
    "StateEnergyOrigin":
        "MolecularStateCharacterisation.StateEnergy.@energyOrigin",
    "TotalStatisticalWeight":
        "MolecularStateCharacterisation.TotalStatisticalWeight",
    "NuclearSpinIsomerName":
        "MolecularStateCharacterisation.NuclearSpinIsomer.Name",
    "NuclearSpinIsomerLowestEnergy":
        "MolecularStateCharacterisation.NuclearSpinIsomer.@lowestEnergyStateRef",
...
MOLECULES_DICT = {
    ...
    "MolecularChemicalSpecies.OrdinaryStructuralFormula.Value",
    "MolecularWeight":
    "MolecularChemicalSpecies.StableMolecularProperties.MolecularWeight.Value",
    "StoichiometricFormula":
    "MolecularChemicalSpecies.StoichiometricFormula",
    "PartitionFunction":
    "MolecularChemicalSpecies.PartitionFunction[]\\Partitionfunctions",
...
DICT_MODELS = {
    ...
    'dict_types': [
        ...
        {'Name': 'RadiativeTransitions',
         'Dictionary': {"RadiativeTransitions":
                        "Processes.Radiative.RadiativeTransition[]\\self"},
         'Type': 'RadiativeTransition'},
        {'Name': 'CollisionalTransitions',
         'Dictionary': {"CollisionalTransitions":
                        "Processes.Collisions.CollisionalTransition[]\\self"},
...
def calculate_partitionfunction(states, temperature=300.0):
    ...
    for specie in distinct_list:
        ...
        for state in distinct_list[specie]:
            pfs[specie] += (
                float(distinct_list[specie][state].TotalStatisticalWeight)
                * numpy.exp(-1.43878
                            * float(distinct_list[specie][state]
                                    .StateEnergyValue)
                            / temperature))
